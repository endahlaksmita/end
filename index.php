...
<script type="text/javascript">
	var peta;
	var gambar_tanda;
	gambar_tanda = 'assets/img/map.png';
	
	function peta_awal(){
		// posisi default peta saat diload
	    var lokasibaru = new google.maps.LatLng(-7.986246,112.628647);
    	var petaoption = {
			zoom: 13,
			center: lokasibaru,
...
<div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">SPBU MALANG</a>
